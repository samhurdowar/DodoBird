        ...
        success: function (data) {
            ...
            for (var i = 0; i < formSections.length; i++) {
                ...
                for (var x = 1; x <= row.ColumnCount; x++) {
                    ...
                    let sectionColumns = data.FormColumns.filter(w => w.FormSectionId == row.FormSectionId && w.SectionColumn == x);
            ...
            for (var i = 0; i < ray.length; i++) {
                $("#" + ray[i]).sortable({
                    ...
                    stop: function (event, ui) {
                        ...
                        if (id.indexOf("AvailColumn_") > -1 && TargetId.indexOf("availColumns") > -1 ) { return; }
