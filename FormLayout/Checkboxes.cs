			...
			using (SourceControlEntities Db = new SourceControlEntities())
			{
				...
				if (recs != null)
				{
					foreach (var rec in recs)
					{
						...
						sb.AppendLine("<input type='checkbox' id='P" + PageTemplateId + "_" + columnDef.ColumnName + "' name='P" + PageTemplateId + "_" + columnDef.ColumnName + "' class='site-checkbox' value='" + rec.ValueField + "'> " + rec.TextField);
						sb.AppendLine("</li>");
					}
				}
