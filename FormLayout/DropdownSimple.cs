...
namespace SourceControl.FormLayoutClasses
{
	public partial class FormLayout
	{
		...
		public string DropdownSimple(ColumnDef columnDef)
		{
			...
			sb.AppendLine("<input type='text' id='P" + PageTemplateId + "_" + columnDef.ColumnName + "' name='P" + PageTemplateId + "_" + columnDef.ColumnName + "' style='width:" + columnWidth + "px;' />");

			DocumentReady.AppendLine("$('#Form_" + columnDef.PageTemplateId + " input[id=P" + PageTemplateId + "_" + columnDef.ColumnName + "] ').kendoDropDownList({");
