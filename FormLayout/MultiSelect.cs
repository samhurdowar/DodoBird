...
namespace SourceControl.FormLayoutClasses
{
	public partial class FormLayout
	{
		public string MultiSelect(ColumnDef columnDef)
		{
			...
			DocumentReady.AppendLine("$('#P" + PageTemplateId + "_" + columnDef.ColumnName + "').kendoMultiSelect({");
			...
			sb.AppendLine("<select id='P" + PageTemplateId + "_" + columnDef.ColumnName + "' name='P" + PageTemplateId + "_" + columnDef.ColumnName + "' multiple='multiple' style='width:" + columnDef.ElementWidth + "px'></select>");
			sb.AppendLine("");
